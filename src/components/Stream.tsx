      ...
      <div className="stream-cont">
        ...
        <div className="stream">
          ...
          >
            ...
            Player
            {showElement && (
              <h4 className="stream-element-popup">Listen on Monstercat</h4>
            )}
            {showElement && (
          ...
          <StreamElement
            children="Listen on Bandcamp"
            platform={<FaBandcamp />}
          />
          <StreamElement
            children="Listen on Soundcloud"
            platform={<FaSoundcloud />}
          />
          <StreamElement
            children="Listen on AppleMusic"
            platform={<FaApple />}
          />
          <StreamElement
            children="Listen on Youtube"
            platform={<FaYoutube />}
          />
          <StreamElement
